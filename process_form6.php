...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 1; $i <= 2; $i++) {
        ...
        $kpiData = [
            ["On time Scrutiny of Documents by QC", "Number of Documents verified within time / Total numberof documents received*
            a. Document Contains less 25 page = one working days
            b. Document Contains more than 25 page = two working days"],
            ["Drawings Clearance by QC", "Number of Drawing verified in time/ Total number of Drawing received*
            a. Part Level drawing = Ten per day
            b. Sub assembly drawing =Two per day
            c. Assembly level drawing =One per day"],
        ...
        $tableSql = "INSERT INTO kpi_table_contents_6 (kpi_name, measurement_method, completed_tasks, target_percentage, achievement_percentage, action_taken, ref_of_evidence) VALUES (?, ?, ?, ?, ?, ?, ?)";
