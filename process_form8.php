...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 1; $i <= 2; $i++) {
        ...
        $kpiData = [
            ["Tag obtained from DGAQA", "Number of LRUs Tagged Vs Number of LRUs received for Tagging*"],
            ["Tag Downgraded by QC", "Number of Tag downgraded Vs Number of DR controlled*"],
        ...
        $tableSql = "INSERT INTO kpi_table_contents_8 (kpi_name, measurement_method, completed_tasks, target_percentage, achievement_percentage, action_taken, ref_of_evidence) VALUES (?, ?, ?, ?, ?, ?, ?)";
