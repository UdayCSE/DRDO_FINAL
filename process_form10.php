...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 1; $i <= 1; $i++) {
        ...
        $kpiData = [
            ["Ensure the availability of machine /chamber/ Test Facility in QC", "Number of machines or chambers or facility available for Test Vs Total number of Machines or chambers or facility commissioned in QCG"],
        ...
        $tableSql = "INSERT INTO kpi_table_contents_10 (kpi_name, measurement_method, completed_tasks, target_percentage, achievement_percentage, action_taken, ref_of_evidence) VALUES (?, ?, ?, ?, ?, ?, ?)";
