...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 1; $i <= 2; $i++) {
        ...
        $kpiData = [
            ["Review / Update Of Procedures Related QC Activities", "Number of procedures reviewed vs number of procedures due for review *"],
            ["Review / Update of Forms and Formats Related QC Activites", "Number of forms and formats reviewed vs Total number of forms and formats due for review*"],
        ...
        $tableSql = "INSERT INTO kpi_table_contents_5 (kpi_name, measurement_method, completed_tasks, target_percentage, achievement_percentage, action_taken, ref_of_evidence) VALUES (?, ?, ?, ?, ?, ?, ?)";
